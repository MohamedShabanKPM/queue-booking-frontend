  ...
  template: `
    <div class="language-switcher">
      <button 
        ...
        <span *ngIf="i18n.getCurrentLanguage() === 'ar'" class="flag-icon flag-us"></span>
        <span *ngIf="i18n.getCurrentLanguage() === 'en'" class="flag-icon flag-eg"></span>
        <span *ngIf="i18n.getCurrentLanguage() === 'ar'">{{ 'language.english' | translate }}</span>
        <span *ngIf="i18n.getCurrentLanguage() === 'en'">{{ 'language.arabic' | translate }}</span>
      </button>
    </div>
  `,
  styles: [`
